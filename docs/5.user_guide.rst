...
8. Go into the following folder: ::
    ...
    $ cd deep_bottleneck/deep_bottleneck
...
10. Activate the dneck environment: ::
      ...
      $ cd net/projects/scratch/summer/valid_until_31_January_2019/bottleneck/miniconda
      $ source activate dneck

If that does not work than check your python path and see if ./miniconda/bin is already added to your path.
